      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: "grid", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 6 }}>
            <button type="button" onClick={onClose} style={{ padding: "8px 12px", borderRadius: 8, background: "#F3F4F6", border: "1px solid #E5E7EB", cursor: "pointer" }}>Cancel</button>
            <button type="submit" style={{ padding: "8px 12px", borderRadius: 8, background: "#4F46E5", color: "#fff", border: "1px solid transparent", cursor: "pointer" }}>Continue</button>
          </div>
        </form>
      </div>
    </div>
